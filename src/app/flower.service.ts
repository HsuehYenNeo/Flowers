...
export class FlowerService {
  ...
  loadFlowerDetailsData() {
    this.httpClient.get<FlowerDetails[]>(this.FLOWER_API_BASE_URL+'/flower-infos.json').subscribe((data: FlowerDetails[]) => {
  ...
  getFlowerDetails(id:number) {
    ...
    if(!tempFlower) {    
      tempFlower = { id:0,description:"Loading ...",photo:"error",price:0} as FlowerDetails;
    }
    return tempFlower;
  }
